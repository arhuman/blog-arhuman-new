...
* Je suis fier d'être un Gopher (et je produis un [podcast sur le langage Go en Français](https://gofr.fm))
* Dans une précédente vie, j'ai fait pas mal de sécurité informatique (J'ai d'ailleurs un DEA en cryptographie)
* J'ai pratiqué plusieurs Arts Martiaux (Arnis Ilustrisimo, Vo thuat, Muay Thai, Pencak Silat, Tae Kwon Do, Jiu Jitsu Brésilien...)
* J'ai codé en de nombreux languages informatiques (incluant le COBOL)

Si vous préférez des informatiels plus conventielles ou si vous avez besoins de référents/recommandations, vous pouvez consulter mon [profile Linkedin](https://www.linkedin.com/in/arnaudassad/)
