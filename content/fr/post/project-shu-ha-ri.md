...
- `Shu` : Dont on traduit souvent le sens par "Suivre la technique"
- `Ha` : Qu'on associe à "Modifier/intégrer la technique"
- `Ri` :  Qu'on interprète comme "(Se) libérer (de) la technique"
...
- Les équipes qui appliquent mal la méthode (pas assez de `Shu`)
- les équipes qui restent bloquées à l'application rigide de la méthode et à la défense de l'orthodoxie (trop de `Shu`)
- Les équipes qui la déforment en voulant la modifier avant de l'appliquer correctement et de la comprendre (Mauvais `Ha`)
